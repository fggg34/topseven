...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6"><?php echo e(__('Register')); ?></h1>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-6">
            <a class="underline text-sm text-gray-600 hover:text-lime-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-500" href="<?php echo e(route('login')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\Administrator\Desktop\Projects\TOP7\topseven\resources\views\auth\register.blade.php ENDPATH**/ ?>