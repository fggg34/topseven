    ...
    <body class="font-sans antialiased bg-[#f5f3ef] text-gray-900">
        ...
        <main class="pt-28 pb-16 md:pb-20 px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-8rem)]">
            <div class="max-w-[440px] mx-auto">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! (request()->routeIs('login', 'register', 'password.request'))): ?>
                ...
                <p class="text-center mt-8 text-sm text-gray-500">
                    <a href="<?php echo e(route('home')); ?>" class="text-[#111827] font-medium hover:text-lime-700 transition-colors">← Back to home</a>
                </p>
            </div>
        </main>
