        ...
        <div class="flex flex-col gap-4 pt-2">
            ...
            <div class="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-sm">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('password.request')): ?>
                    <a class="text-gray-600 hover:text-[#111827] font-medium transition-colors" href="<?php echo e(route('password.request')); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('register')): ?>
                    <a class="text-lime-700 hover:text-lime-800 font-semibold transition-colors" href="<?php echo e(route('register')); ?>">
