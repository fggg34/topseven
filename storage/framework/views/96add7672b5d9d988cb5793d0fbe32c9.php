...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-6"><?php echo e(__('Verify Email')); ?></h1>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            ...
            <button type="submit" class="underline text-sm text-gray-600 hover:text-lime-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-500">
...
<?php endif; ?>
<?php /**PATH C:\Users\Administrator\Desktop\Projects\TOP7\topseven\resources\views\auth\verify-email.blade.php ENDPATH**/ ?>