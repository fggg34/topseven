    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div class="flex items-center justify-between gap-4">
            <div class="flex flex-col min-w-0">
                ...
                <span class="text-lg font-bold text-lime-600"><?php echo e($currency); ?> <?php echo e($formattedPrice); ?> <span class="text-xs font-normal text-gray-500">/ person</span></span>
            </div>
            <button type="button"
...
<?php /**PATH C:\Users\Administrator\Desktop\Projects\TOP7\topseven\resources\views\components\mobile-booking-bar.blade.php ENDPATH**/ ?>