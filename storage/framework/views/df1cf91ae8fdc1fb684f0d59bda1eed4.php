...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <h1 class="text-[28px] sm:text-[32px] font-serif font-semibold text-[#111827] tracking-tight leading-tight mb-2"><?php echo e(__('Forgot Password')); ?></h1>
...
<?php endif; ?>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-2">
            <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-gray-600 hover:text-[#111827] transition-colors order-2 sm:order-1"><?php echo e(__('Back to log in')); ?></a>
...
<?php endif; ?>
<?php /**PATH /Users/kevinhitaj/Desktop/Projects/TOP 7 TRAVEL/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>