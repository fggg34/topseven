...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto">
            <div class="mb-10">
                <h1 class="text-2xl font-bold text-gray-900"><?php echo e(__('Profile')); ?></h1>
                <p class="mt-1 text-gray-600"><?php echo e(__('Update your account information and preferences.')); ?></p>
            </div>
