...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['action' => route('tours.index'), 'placeholder' => 'Search tours...']));
...
foreach (array_filter((['action' => route('tours.index'), 'placeholder' => 'Search tours...']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH C:\Users\Administrator\Desktop\Projects\TOP7\topseven\resources\views\components\search-bar.blade.php ENDPATH**/ ?>