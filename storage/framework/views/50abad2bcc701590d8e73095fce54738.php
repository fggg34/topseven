...
<?php $__env->startSection('description', \App\Models\Setting::get('page_about_seo_description') ?: 'The story behind our travel packages, our team, and why we love sharing Albania with you.'); ?>
...
<section class="relative w-full overflow-hidden rounded-b-[40px]" style="height: 560px;">
    <div class="absolute inset-0 bg-cover bg-center transition-transform duration-[1.2s] hover:scale-[1.02]" style="background-image: url('<?php echo e($heroBg); ?>');"></div>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($introTitle || $introContent): ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-20 items-start">
            <div class="lg:col-span-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($introLabel): ?>
                    <p class="text-[15px] text-gray-500 mb-3"><?php echo e($introLabel); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <h2 class="text-[34px] md:text-[44px] font-serif font-semibold text-gray-900 leading-[1.08]"><?php echo e($introTitle); ?></h2>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($introBadgeTitle): ?>
                <div class="inline-flex items-center gap-2 mt-6 rounded-full bg-gray-100 px-4 py-2">
                    <span class="w-2 h-2 rounded-full bg-green-500"></span>
                    <span class="text-[13px] font-medium text-gray-700"><?php echo e($introBadgeTitle); ?></span>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <div class="lg:col-span-3">
                ...
                <div class="text-[17px] text-gray-600 leading-[1.8] space-y-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = explode("\n\n", $introContent); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $para): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(trim($para)): ?><p><?php echo e($para); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="max-w-[1400px] mx-auto">
        <div class="grid grid-cols-12 gap-3 md:gap-4">
            <div class="col-span-12 md:col-span-7 rounded-[24px] overflow-hidden">
                <img src="<?php echo e($introImageUrl); ?>" alt="Our team" class="w-full h-full object-cover" style="aspect-ratio: 16/10; min-height: 300px;">
            </div>
            <div class="col-span-6 md:col-span-5 rounded-[24px] overflow-hidden">
                <img src="<?php echo e($expectImage1Url); ?>" alt="Our journeys" class="w-full h-full object-cover" style="aspect-ratio: 1/1; min-height: 200px;">
            </div>
            <div class="col-span-6 md:col-span-5 rounded-[24px] overflow-hidden">
                <img src="<?php echo e($expectImage2Url); ?>" alt="Our destinations" class="w-full h-full object-cover" style="aspect-ratio: 1/1; min-height: 200px;">
            </div>
    ...
    <div class="max-w-[1400px] mx-auto">
        <div class="mb-10 md:mb-14">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($valuesLabel): ?>
                <p class="text-[15px] text-gray-500 mb-2"><?php echo e($valuesLabel); ?></p>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <h2 class="text-[34px] md:text-[48px] font-serif font-semibold text-gray-900 leading-[1.05] tracking-tight"><?php echo e($valuesTitle); ?></h2>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div class="bg-gray-100 rounded-2xl p-8 lg:p-10">
                ...
                <div class="w-12 h-12 rounded-xl bg-gray-900 flex items-center justify-center mb-6">
                    <i class="fa-solid <?php echo e($val['icon']); ?> text-white text-base"></i>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($val['title'])): ?>
                    <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($val['title']); ?></h3>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($val['description'])): ?>
                    <p class="text-[15px] text-gray-600 leading-relaxed"><?php echo e($val['description']); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
            ...
            <div class="relative flex items-center justify-center px-6 md:px-16 py-14 text-center" style="min-height: 340px;">
                <div class="max-w-3xl">
                    ...
                    <blockquote class="text-2xl md:text-[34px] font-serif text-white leading-[1.25]">
                        &ldquo;<?php echo e($quoteText); ?>&rdquo;
                    </blockquote>
                    <p class="mt-6 text-sm text-white/45"><?php echo e($siteName); ?> Team</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="px-4 sm:px-6 md:px-[80px] pb-16 md:pb-24">
    <div class="max-w-[1400px] mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-20 items-start mb-12">
            <div class="lg:col-span-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($expectLabel): ?>
                    <p class="text-[15px] text-gray-500 mb-3"><?php echo e($expectLabel); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <h2 class="text-[34px] md:text-[44px] font-serif font-semibold text-gray-900 leading-[1.08]"><?php echo e($expectTitle); ?></h2>
            </div>
            <div class="lg:col-span-3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $expectItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="flex gap-5 rounded-2xl border border-gray-200 bg-white p-7 hover:border-gray-300 hover:shadow-sm transition-all">
                <span class="w-10 h-10 rounded-full bg-gray-900 text-white text-sm font-bold flex items-center justify-center flex-shrink-0"><?php echo e($i + 1); ?></span>
                <div class="min-w-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['title'])): ?>
                        <h4 class="text-[17px] font-bold text-gray-900 mb-1"><?php echo e($item['title']); ?></h4>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item['description'])): ?>
                        <p class="text-[15px] text-gray-500 leading-relaxed"><?php echo e($item['description']); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <div class="relative overflow-hidden rounded-[28px] bg-gray-900 px-8 md:px-16 py-14 md:py-20 shadow-xl shadow-black/20">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div class="flex flex-wrap justify-center md:justify-end gap-3">
                    <a href="<?php echo e(route('tours.index')); ?>" class="inline-flex items-center rounded-full bg-white text-gray-900 text-sm font-semibold px-7 py-3.5 hover:bg-gray-100 transition-colors">
                        Browse travel packages
                    </a>
                    <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center rounded-full border border-white/30 text-white text-sm font-semibold px-7 py-3.5 hover:bg-white/10 transition-colors">
                        Get in touch
                    </a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.site', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/kevinhitaj/Desktop/Projects/TOP 7 TRAVEL/resources/views/pages/about.blade.php ENDPATH**/ ?>