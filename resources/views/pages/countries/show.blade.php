    ...
    <section class="px-4 sm:px-6 lg:px-[80px] pb-16">
        <div class="max-w-[1400px] mx-auto">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mt-8">
                <a href="{{ route('tours.index', ['country' => $country->slug]) }}" class="inline-flex items-center justify-center rounded-full bg-[#323c7b] text-white text-sm font-semibold px-6 py-2.5 hover:bg-[#282d6a] transition-colors">
