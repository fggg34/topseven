...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // Default Livewire max was 12MB (12288 KB) — too small for hero videos. Size is in kilobytes (Laravel max rule).
        // Match PHP upload_max_filesize / post_max_size and your web server body limit (e.g. nginx client_max_body_size).
        'rules' => ['file', 'max:'.(int) (env('LIVEWIRE_MAX_UPLOAD_KB') ?: 262144)], // 262144 KB ≈ 256 MB
        ...
        'max_upload_time' => (int) (env('LIVEWIRE_MAX_UPLOAD_MINUTES') ?: 15), // Large/slow uploads
